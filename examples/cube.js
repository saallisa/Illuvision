...
async function main()
{
    ...
    // Create a simple box
    const boxGeometry = new VYXEN.Box(0.5, 0.5, 0.5);
    ...
    sceneNode2.setPosition(new VYXEN.Vector3(0, 0.5, 0));
    ...
    const camera = new VYXEN.OrthographicCamera(-1, 1, 1, -1, 0, 20);
    camera.setAspectRatio(engine.getAspectRatio());
    camera.setTarget(new VYXEN.Vector3(0, 0, 0));
    camera.setPosition(new VYXEN.Vector3(10, 5, 10));
